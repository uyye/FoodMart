        ...
        <div className="detailProduct">
          ...
          <div className="orderForm">
            ...
            <div className="formSubmit">
              <button className="orderSubmit" onClick={handleButtonAddToCart}>
                Tambah ke keranjang
              </button>
              <button className="orderSubmit" onClick={handleBuyNow}>
                Beli sekarang
              </button>
            </div>
          </div>
